...
router.post('/', authenticate, controller.assignSpeakerToCourse); // Asignar ponente a curso (solo admin)
...
router.delete('/:course_id/:speaker_id', authenticate, controller.removeSpeakerFromCourse); // Eliminar asignación (solo admin)
