...
router.post('/', authenticate, controller.createCourse); // Crear un nuevo curso (solo admin)
router.put('/:id', authenticate, controller.updateCourse); // Actualizar un curso
router.delete('/:id', authenticate, controller.deleteCourse); // Eliminar un curso (solo admin)
