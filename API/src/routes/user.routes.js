...
router.get('/', authenticate, controller.getAllUsers); // Obtener todos los usuarios (solo admin)
...
router.delete('/:id', authenticate, controller.deleteUser); // Eliminar un usuario (solo admin)
