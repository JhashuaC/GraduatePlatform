...
export default function SpeakerLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 relative">
      ...
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-sky-800 text-white z-50 shadow-lg p-6 overflow-y-auto transition-transform duration-300 ${
      ...
      {/* Navbar fijo */}
      <nav className="bg-sky-800 text-white px-6 py-4 fixed top-0 left-0 w-full z-30 shadow-md">
