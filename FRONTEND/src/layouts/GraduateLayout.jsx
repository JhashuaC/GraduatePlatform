...
export default function GraduateLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 relative">
      ...
      {/* Sidebar animado */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-blue-900 text-white z-50 shadow-lg p-6 overflow-y-auto transform transition-transform duration-300 ease-in-out ${showSidebar ? "translate-x-0" : "-translate-x-full"
          }`}
      >
